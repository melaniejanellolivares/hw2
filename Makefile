...
amazon.o: amazon.cpp db_parser.h datastore.h product_parser.h mydatastore.h product.h user.h 
...
book.o: product.h book.h book.cpp 
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c book.cpp
movie.o: product.h movie.h movie.cpp 
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c movie.cpp
clothing.o: product.h clothing.h clothing.cpp 
