...
{
	Product* newProd = new Book(categoryID(), prodName_, price_, qty_, isbn_, author_);
...
{
	Product* newProd = new Clothing(categoryID(), prodName_, price_, qty_, size_, brand_);
...
{
	Product* newProd = new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_);
